...
export function AlertToaster() {
  ...
  return (
    <div
      className="pointer-events-none fixed inset-x-0 top-20 z-[70] mx-auto flex w-full max-w-md flex-col gap-2 px-3 lg:left-auto lg:right-4 lg:top-3 lg:mx-0 lg:max-w-sm lg:px-0"
      aria-live="polite"
